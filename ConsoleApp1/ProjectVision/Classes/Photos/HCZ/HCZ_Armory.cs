...
{
    internal class HCZ_Armory : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.HczArmory };
        public override string ImageName { get; set; } = "HCZ_Armory.png";
