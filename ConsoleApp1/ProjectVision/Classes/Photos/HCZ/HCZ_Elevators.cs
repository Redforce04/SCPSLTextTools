...
{
    internal class HCZ_Elevators : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.HczChkpB, RoomType.HczChkpA };
        public override string ImageName { get; set; } = "HCZ_Elevators.png";
