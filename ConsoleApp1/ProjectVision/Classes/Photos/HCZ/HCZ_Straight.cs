...
{
    internal class HCZ_Straight : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.HczStraight };
        public override string ImageName { get; set; } = "HCZ_Straight.png";
