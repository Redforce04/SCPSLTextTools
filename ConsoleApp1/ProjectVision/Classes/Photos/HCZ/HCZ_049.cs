...
{
    internal class HCZ_049 : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>(){ RoomType.Hcz049 };
        public override string ImageName { get; set; } = "HCZ_049.png";
