...
{
    internal class HCZ_ThreeWay : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.HczTCross };
        public override string ImageName { get; set; } = "HCZ_ThreeWay.png";
