...
{
    internal class HCZ_Curve : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.HczCurve };
        public override string ImageName { get; set; } = "HCZ_Curve.png";
