...
{
    internal class HCZ_Tesla : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.HczTesla };
        public override string ImageName { get; set; } = "HCZ_Tesla.png";
