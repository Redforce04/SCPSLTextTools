...
{
    internal class HCZ_Nuke : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.HczNuke };
        public override string ImageName { get; set; } = "HCZ_Nuke.png";
