...
{
    internal class HCZ_StraightThick : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.Hcz939, RoomType.HczServers };
        public override string ImageName { get; set; } = "HCZ_StraightThick.png";
