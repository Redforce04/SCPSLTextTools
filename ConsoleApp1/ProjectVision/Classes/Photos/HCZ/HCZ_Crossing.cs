...
{
    internal class HCZ_Crossing : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.HczCrossing };
        public override string ImageName { get; set; } = "HCZ_Crossing.png";
