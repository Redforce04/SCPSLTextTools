...
{
    internal class HCZ_EndLarge : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.Hcz106, RoomType.Hcz079 };
        public override string ImageName { get; set; } = "HCZ_EndLarge.png";
