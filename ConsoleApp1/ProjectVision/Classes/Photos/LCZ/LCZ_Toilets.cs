...
{
    internal class LCZ_Toilets : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.LczToilets };
        public override string ImageName { get; set; } = "LCZ_Toilets.png";
