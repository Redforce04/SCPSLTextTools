...
{
    internal class LCZ_LargeEnd : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.LczGlassBox, RoomType.Lcz173 };
        public override string ImageName { get; set; } = "LCZ_LargeEnd.png";
