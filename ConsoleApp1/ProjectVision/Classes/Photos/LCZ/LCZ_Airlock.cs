...
{
    internal class LCZ_Airlock : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.LczAirlock};
        public override string ImageName { get; set; } = "LCZ_Airlock.png";
