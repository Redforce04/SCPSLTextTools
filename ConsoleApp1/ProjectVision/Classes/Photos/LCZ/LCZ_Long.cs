...
{
    internal class LCZ_Long : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.LczClassDSpawn };
        public override string ImageName { get; set; } = "LCZ_Long.png";
