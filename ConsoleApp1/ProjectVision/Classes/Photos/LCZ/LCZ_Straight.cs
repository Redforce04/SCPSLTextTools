...
{
    internal class LCZ_Straight : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.LczStraight };
        public override string ImageName { get; set; } = "LCZ_Straight.png";
