...
{
    internal class LCZ_Wide : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.LczPlants };
        public override string ImageName { get; set; } = "LCZ_Wide.png";
