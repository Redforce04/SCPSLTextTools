...
{
    internal class LCZ_Checkpoint : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.LczChkpA, RoomType.LczChkpB };
        public override string ImageName { get; set; } = "LCZ_Checkpoint.png";
