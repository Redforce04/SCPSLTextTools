...
{
    internal class LCZ_Curve : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.LczCurve };
        public override string ImageName { get; set; } = "LCZ_Curve.png";
