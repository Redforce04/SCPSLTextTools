...
{
    internal class LCZ_SmallEnd : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.Lcz330, RoomType.LczArmory, RoomType.LczCafe, RoomType.Lcz914};
        public override string ImageName { get; set; } = "LCZ_SmallEnd.png";
