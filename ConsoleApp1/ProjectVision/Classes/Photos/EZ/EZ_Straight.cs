...
{
    internal class EZ_Straight : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.EzStraight };
        public override string ImageName { get; set; } = "EZ_Straight.png";
