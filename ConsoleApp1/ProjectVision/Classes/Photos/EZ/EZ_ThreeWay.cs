...
{
    internal class EZ_ThreeWay : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.EzTCross };
        public override string ImageName { get; set; } = "EZ_ThreeWay.png";
