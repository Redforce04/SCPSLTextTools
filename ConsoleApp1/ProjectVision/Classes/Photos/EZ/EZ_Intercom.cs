...
{
    internal class EZ_Intercom : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.EzIntercom };
        public override string ImageName { get; set; } = "EZ_Intercom.png";
