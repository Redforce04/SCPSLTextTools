...
{
    internal class EZ_NonGateEnd : PhotoInfo
    {
        public override List<RoomType> Type { get; set; } = new List<RoomType>() { RoomType.EzVent, RoomType.EzShelter };
        public override string ImageName { get; set; } = "EZ_NonGateEnd.png";
